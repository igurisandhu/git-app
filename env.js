 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.gtapp.staging
 */

const BUNDLE_ID = 'com.gtapp'; // ios bundle id
const PACKAGE = 'com.gtapp'; // android package name
const NAME = 'gtApp'; // app name
